...
abstract class UpdateRequestByAdminRepo {
  Future<Either<Failure, UpdateRequestByAdminModel>> updateRequestByAdmin({required String token,required String endPoint,required int id, required double salary,});
}
